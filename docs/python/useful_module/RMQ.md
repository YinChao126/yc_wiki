...
#import threading
#import queue
test_beat_interval = 300 #默认5分钟不断开连接
    ...
    def SendMsg(self, msg):
        try:
            self.connection = pika.BlockingConnection(pika.ConnectionParameters(host = self.ip, 
                heartbeat_interval=test_beat_interval))#建立一个阻塞连接
    ...
    def Running(self):
        ...
        while True:
            try:
                ...
                self.connection = pika.BlockingConnection(pika.ConnectionParameters(host=self.ip, 
                    heartbeat_interval=test_beat_interval))
        ...
        #            #用完就删的配置
            ...
            # Recover on all other connection errors
                ...
                print('/n/n/ntry to reconnect/n/n/n')
                continue
            except pika.exceptions.ConnectionClosed:
                print('/n/n/nerror, connection closed/n/n/n')
                continue
